...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#cal-menu">
    ...
    <div class="page container-fluid">
      <div class="row">
        <div class="col-sm-6 left-side">
          <header class="sitetitle">
            <div class="row">
              ...
              <!-- <div class="col-xs-8 text-right">
                <ul id="main-nav" class="list-unstyled list-inline">
          ...
          <div id="theseason" class="wrap season" data-season="<?php echo get_seasons('current', 3, $this_year); ?>">
                  ...
                  <div class="seasontitle">
                    ...
                    <small><span class="startdate"><?php echo date("F dS", strtotime(get_seasons('current', 0, $this_year))); ?></span> &ndash; <span class="enddate"><?php echo date("F dS", strtotime(get_seasons('current', 1, $this_year))); ?></span></small></h1>
                  </div>
          </div>
          
          <div class="wrap content dark hidden-xs">
            <section id="about2">
              <h3>About</h3>
              <p>The purpose of this tool is to share information, in order to serve and unite us.</p>
              ...
              <br/>  
              <p>A project by <a href="https://twitter.com/abaumer">Austin</a></p>
              <p><a href="https://github.com/abaumer/churchcalendar">View on github</a></p>
            </section>
          </div>
        </div>
        ...
        <div class="col-sm-6 right-side">
          ...
          <div id="cal-menu" class="calBlocks">
            <ul class="nav">
              <li><a id="block1" class="s1a" href="#advent">Advent</a></li>
              <li><a id="block2" class="s2c" href="#christmas">Christmas</a></li>
              <li><a id="block3" class="s3e" href="#epiphany">Epiphany</a></li>
              <li><a id="block4" class="s4o" href="#ordinary1">Ordinary</a></li>
              <li><a id="block5" class="s5l" href="#lent">Lent</a></li>
              <li><a id="block6" class="s6e" href="#easter">Easter</a></li>
              <li><a id="block7" class="s7p" href="#pentecost">Pentecost</a></li>
              <li><a id="block8" class="s8o" href="#ordinary2">Ordinary</a></li>
            </ul>
          </div>
          ...
          <div id="calendar" class="wrap content">
            <section id="advent">
              <article>
                <h2>Advent</h2>
                <h3><span class="startdate"><?php echo date("F d, Y", strtotime(get_seasons('advent', 0, $this_year))); ?></span> &ndash; <span class="enddate"><?php echo date("F d, Y", strtotime(get_seasons('advent', 1, $this_year))); ?></span></h3>
                ...
                <p><b>The Sundays of Advent</b>
                  <br/>1st Sunday: Wait &mdash; Isaiah 7:14
                  <br/>2nd Sunday: Prepare &mdash; Luke 3:4
                  <br/>3rd Sunday: Rejoice &mdash; Luke 1:46
                  <br/>4th Sunday: Love &mdash; John 3:16</p>
                <p><b>Colors:</b> Purple (color of repentence & reflection), Pink (joy), Blue (hope)
                  ...
                  <br/><b>Themes:</b> reflect, repent, wait, prepare, hope
                  <br/><b>Calendar:</b> Begins 4 Sundays before Christmas - Ends Christmas Eve</p>
              </article>
            </section>
            <section id="christmas">
              <article>
                <h2>Christmas</h2>
                <h3><span class="startdate"><?php echo date("F d, Y", strtotime(get_seasons('christmas', 0, $this_year))); ?></span> &ndash; <span class="enddate"><?php echo date("F d, Y", strtotime(get_seasons('christmas', 1, $this_year))); ?></span></h3>
                ...
                <p><b>Colors:</b> White (Christ, purity, innocence, joy), Gold (royalty, triumph)
                  ...
                  <br/><b>Themes:</b> Nativity, Christ, Birth
                  <br/><b>Calendar:</b> Begins on Christmas - Ends the 12th day after Christmas (Jan. 5th)</p>
              </article>
            </section>
            <section id="epiphany">
              <article>
                <h2>Epiphany</h2>
                <h3><span class="startdate"><?php echo date("F d, Y", strtotime(get_seasons('epiphany', 0, $this_year))); ?></span> &ndash; <span class="enddate"><?php echo date("F d, Y", strtotime(get_seasons('epiphany', 1, $this_year))); ?></span></h3>
                ...
                <p><b>Colors:</b> White (purity, joy)
                  ...
                  <br/><b>Themes:</b> Magi, Baptism, gifts, giving, home
                  <br/><b>Calendar:</b> Begins and ends on January 6th.  A single day season.</p>
              </article>
            </section>
            <section id="ordinary1">
              <article>
                <h2>Ordinary Time 1</h2>
                <h3><span class="startdate"><?php echo date("F d, Y", strtotime(get_seasons('ordinary1', 0, $this_year))); ?></span> &ndash; <span class="enddate"><?php echo date("F d, Y", strtotime(get_seasons('ordinary1', 1, $this_year))); ?></span></h3>
                ...
                <p><b>Colors:</b> Green (growth)
                  ...
                  <br/><b>Themes:</b> Growth, patience, slow, rhythm, present<
                  <br/><b>Calendar:</b> Begins on January 7th - Ends the Tuesday before Ash Wednesday, the start of Lent.</p> 
              </article>
            </section>
            <section id="lent">
              <article>
                <h2>Lent</h2>
                <h3><span class="startdate"><?php echo date("F d, Y", strtotime(get_seasons('lent', 0, $this_year))); ?></span> &ndash; <span class="enddate"><?php echo date("F d, Y", strtotime(get_seasons('lent', 1, $this_year))); ?></span></h3>
                ...
                <p><b>Colors:</b> Purple (repentence), Black (death, mourning)
                  ...
                  <br/><b>Themes:</b> repent, fast, reflect, charity
                  <br/><b>Calendar:</b> Begins on Ash Wednesday (40 days before Easter, excluding Sundays) - Ends the day before Easter</p>
              </article>
            </section>
            <section id="easter">
              <article>
                <h2>Easter</h2>
                <h3><span class="startdate"><?php echo date("F d, Y", strtotime(get_seasons('easter', 0, $this_year))); ?></span> &ndash; <span class="enddate"><?php echo date("F d, Y", strtotime(get_seasons('easter', 1, $this_year))); ?></span></h3>
                ...
                <p><b>Colors:</b> White (purity, joy), Gold (royalty, triumph)
                  ...
                  <br/><b>Themes:</b> resurrection, life, triumph, joy, majesty
                  <br/><b>Calendar:</b> Begins on Easter Sunday, the Sunday after the Full Moon on/after the Vernal Equinox - Ends 50 days later</p>
              </article>
            </section>
            <section id="pentecost">
              <article>
                <h2>Pentecost</h2>
                <h3><span class="startdate"><?php echo date("F d, Y", strtotime(get_seasons('pentecost', 0, $this_year))); ?></span> &ndash; <span class="enddate"><?php echo date("F d, Y", strtotime(get_seasons('pentecost', 1, $this_year))); ?></span></h3>
                ...
                <p><b>Colors:</b> Red (fire)
                  ...
                  <br/><b>Themes:</b> joy, delight, trinity, holy spirit
                  <br/><b>Calendar:</b> Begins on the seventh (7th) Sunday after Easter - Ends the following Sunday, 8 days later.</p>
              </article>
            </section>
            <section id="ordinary2">
              <article>
                <h2>Ordinary Time 2</h2>
                <h3><span class="startdate"><?php echo date("F d, Y", strtotime(get_seasons('ordinary2', 0, $this_year))); ?></span> &ndash; <span class="enddate"><?php echo date("F d, Y", strtotime(get_seasons('ordinary2', 1, $this_year))); ?></span></h3>
                ...
                <p><b>Colors:</b> Green (growth)
                  ...
                  <br/><b>Themes:</b> growth, routine, rhythm, faith
                  <br/><b>Calendar:</b> Begins the Monday after Pentecost - Ends the Saturday before Advent begins.</p>
              </article>
            </section>
          </div>

          <div class="wrap content dark visible-xs">
            <section id="about">
              <h2>About</h2>
