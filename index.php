        ...
        <div class="col-sm-6 right-side">
          ...
          <div id="calendar" class="wrap content">
            <section id="advent">
              <div>
                <h2>Advent</h2>
                <h3><span class="startdate"><?php echo date("M d, Y", strtotime(get_seasons('advent', 0, $this_year))); ?></span> - <span class="enddate"><?php echo date("M d, Y", strtotime(get_seasons('advent', 1, $this_year))); ?></span></h3>
            ...
            <section id="christmas">
              <div>
                <h2>Christmas</h2>
                <h3><span class="startdate"><?php echo date("M d, Y", strtotime(get_seasons('christmas', 0, $this_year))); ?></span> - <span class="enddate"><?php echo date("M d, Y", strtotime(get_seasons('christmas', 1, $this_year))); ?></span></h3>
            ...
            <section id="epiphany">
              <div>
                <h2>Epiphany</h2>
                <h3><span class="startdate"><?php echo date("M d, Y", strtotime(get_seasons('epiphany', 0, $this_year))); ?></span> - <span class="enddate"><?php echo date("M d, Y", strtotime(get_seasons('epiphany', 1, $this_year))); ?></spanh3>
            ...
            <section id="ordinary1">
              <div>
                ...
                <h3><span class="startdate"><?php echo date("M d, Y", strtotime(get_seasons('ordinary1', 0, $this_year))); ?></span> - <span class="enddate"><?php echo date("M d, Y", strtotime(get_seasons('ordinary1', 1, $this_year))); ?></span></h3>
            ...
            <section id="lent">
              <div>
                <h2>Lent</h2>
                <h3><span class="startdate"><?php echo date("M d, Y", strtotime(get_seasons('lent', 0, $this_year))); ?></span> - <span class="enddate"><?php echo date("M d, Y", strtotime(get_seasons('lent', 1, $this_year))); ?></span></h3>
            ...
            <section id="easter">
              <div>
                <h2>Easter</h2>
                <h3><span class="startdate"><?php echo date("M d, Y", strtotime(get_seasons('easter', 0, $this_year))); ?></span> - <span class="enddate"><?php echo date("M d, Y", strtotime(get_seasons('easter', 1, $this_year))); ?></span></h3>
            ...
            <section id="pentecost">
              <div>
                <h2>Pentecost</h2>
                <h3><span class="startdate"><?php echo date("M d, Y", strtotime(get_seasons('pentecost', 0, $this_year))); ?></span> - <span class="enddate"><?php echo date("M d, Y", strtotime(get_seasons('pentecost', 1, $this_year))); ?></span></h3>
            ...
            <section id="ordinary2">
              <div>
                ...
                <h3><span class="startdate"><?php echo date("M d, Y", strtotime(get_seasons('ordinary2', 0, $this_year))); ?></span> - <span class="enddate"><?php echo date("M d, Y", strtotime(get_seasons('ordinary2', 1, $this_year))); ?></span></h3>
